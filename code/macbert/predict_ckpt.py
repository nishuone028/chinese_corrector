...
class Inference:
    def __init__(
            self,
            ckpt_path='outputs-macbert4sighan/epoch=02-val_loss=0.02.ckpt',
            vocab_dir='outputs-macbert4sighan/',
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt_path", default="outputs-macbert4sighan/epoch=02-val_loss=0.02.ckpt",
                        help="path to ckpt file", type=str)
    parser.add_argument("--vocab_dir", default="outputs-macbert4sighan/", help="path to vocab file", type=str)
